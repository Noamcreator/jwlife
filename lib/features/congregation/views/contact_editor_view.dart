...
class ContactEditorView extends StatefulWidget {
  ...
  final String id;
  const ContactEditorView({Key? key, required this.congregationId, required this.id}) : super(key: key);

  @override
  _ContactEditorViewState createState() => _ContactEditorViewState();
}

class _ContactEditorViewState extends State<ContactEditorView> {
