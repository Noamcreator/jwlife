...
import 'package:jwlife/features/congregation/views/contact_editor_view.dart';

class BrothersAndSistersView extends StatefulWidget {
  const BrothersAndSistersView({super.key});

  @override
  _BrothersAndSistersViewState createState() => _BrothersAndSistersViewState();
}

class _BrothersAndSistersViewState extends State<BrothersAndSistersView> {
              ...
              child: Column(
                children: _brothersAndSisters.map((brother) {
                  return GestureDetector(
                    onTap: () {
                      showPage(context, ContactEditorView(congregationId: _selectedCongregationId!, id: brother['id']));
                    },
                    child: Padding(
