...
List<IconLinkInfo> _iconLinks(BuildContext context) {
  return [
    IconLinkInfo('assets/icons/nav_jworg.png', i18n().navigation_official_website, 'https://www.jw.org/${JwLifeSettings.instance.libraryLanguage.value.primaryIetfCode}'),
    IconLinkInfo('assets/icons/nav_jwb.png', i18n().navigation_online_broadcasting, 'https://www.jw.org/open?docid=1011214&wtlocale=${JwLifeSettings.instance.libraryLanguage.value.symbol}'),
    IconLinkInfo('assets/icons/nav_onlinelibrary.png', i18n().navigation_online_library, 'https://wol.jw.org/wol/finder?wtlocale=${JwLifeSettings.instance.libraryLanguage.value.symbol}'),
    IconLinkInfo('assets/icons/nav_donation.png', i18n().navigation_online_donation, 'https://donate.jw.org/ui/${JwLifeSettings.instance.libraryLanguage.value.symbol}/donate-home.html'),
