...
class Category extends _Category
  ...
  Category({
    ...
    RealmObjectBase.set<RealmList<String>>(
        this, 'media', RealmList<String>(media));
    RealmObjectBase.set<RealmList<Category>>(
        this, 'subcategories', RealmList<Category>(subcategories));
  ...
  static final schema = () {
    ...
    return const SchemaObject(ObjectType.realmObject, Category, 'Category', [
      ...
      SchemaProperty('subcategories', RealmPropertyType.object,
          linkTarget: 'Category', collectionType: RealmCollectionType.list),
      SchemaProperty('persistedImages', RealmPropertyType.object,
          optional: true, linkTarget: 'Images'),
...
class Images extends _Images with RealmEntity, RealmObjectBase, RealmObject {
  Images({
    ...
    RealmObjectBase.set(
        this, 'extraWideFullSizeImageUrl', extraWideFullSizeImageUrl);
  ...
  static final schema = () {
    ...
    return const SchemaObject(ObjectType.realmObject, Images, 'Images', [
      SchemaProperty('squareImageUrl', RealmPropertyType.string,
          optional: true),
      SchemaProperty('squareFullSizeImageUrl', RealmPropertyType.string,
          optional: true),
      SchemaProperty('wideImageUrl', RealmPropertyType.string, optional: true),
      SchemaProperty('wideFullSizeImageUrl', RealmPropertyType.string,
          optional: true),
      SchemaProperty('extraWideImageUrl', RealmPropertyType.string,
          optional: true),
      SchemaProperty('extraWideFullSizeImageUrl', RealmPropertyType.string,
          optional: true),
...
class MediaItem extends _MediaItem
    ...
    return switch (ejson) {
      {
        ...
        MediaItem(
          ...
          languageAgnosticNaturalKey:
              fromEJson(ejson['languageAgnosticNaturalKey']),
          type: fromEJson(ejson['type']),
  ...
  static final schema = () {
    ...
    return const SchemaObject(ObjectType.realmObject, MediaItem, 'MediaItem', [
      SchemaProperty('compoundKey', RealmPropertyType.string,
          optional: true, primaryKey: true),
      SchemaProperty('naturalKey', RealmPropertyType.string, optional: true),
      SchemaProperty('languageAgnosticNaturalKey', RealmPropertyType.string,
          optional: true),
      SchemaProperty('type', RealmPropertyType.string, optional: true),
      SchemaProperty('primaryCategory', RealmPropertyType.string,
          optional: true),
      SchemaProperty('title', RealmPropertyType.string, optional: true),
      SchemaProperty('firstPublished', RealmPropertyType.string,
          optional: true),
      SchemaProperty('checksums', RealmPropertyType.string,
          collectionType: RealmCollectionType.list),
      ...
      SchemaProperty('languageSymbol', RealmPropertyType.string,
          optional: true),
      SchemaProperty('realmImages', RealmPropertyType.object,
          optional: true, linkTarget: 'Images'),
