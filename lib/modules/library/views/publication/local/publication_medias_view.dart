...
import 'package:jwlife/modules/library/views/publication/local/full_screen_image_view_local.dart';
import 'package:jwlife/widgets/image_widget.dart';

import 'document/multimedia.dart';

class PublicationMediasView extends StatefulWidget {
  final Document document;

  const PublicationMediasView({super.key, required this.document});

  @override
  _PublicationMediasViewState createState() => _PublicationMediasViewState();
}

class _PublicationMediasViewState extends State<PublicationMediasView> {
