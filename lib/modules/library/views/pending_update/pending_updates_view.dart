...
class PendingUpdatesView extends StatefulWidget {
  const PendingUpdatesView({super.key});

  @override
  _PendingUpdatesViewState createState() => _PendingUpdatesViewState();
}

class _PendingUpdatesViewState extends State<PendingUpdatesView> {
...
''');
  ...
  Widget _buildCategoryButton(BuildContext context, Publication publication, double itemWidth) {
    ...
    try {
      ...
      print("Erreur lors du formatage de la date téléchargée : $e");
    }
