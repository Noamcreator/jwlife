...
class DocumentHtmlWidget extends StatefulWidget {
  ...
  @override
  State<DocumentHtmlWidget> createState() => DocumentHtmlWidgetState();
}

/// State for a [DocumentHtmlWidget].
class DocumentHtmlWidgetState extends State<DocumentHtmlWidget> {
  ...
  @override
  void didUpdateWidget(DocumentHtmlWidget oldWidget) {
...
class _RootResolvers extends InheritanceResolvers {
  final DocumentHtmlWidgetState state;
...
Widget _buildBody(DocumentHtmlWidgetState state, dom.NodeList domNodes) {
