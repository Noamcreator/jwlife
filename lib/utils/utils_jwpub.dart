...
Future<Map<String, dynamic>> downloadJwpubFile(dynamic pub, BuildContext context) async {
  final queryParams = {
    'pub': pub['KeySymbol'],
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      final tempFilePath = '${tempDir.path}/${pub["KeySymbol"]}_${pub["LanguageSymbol"]}.jwpub';

      await dio.download(downloadUrl, tempFilePath);
      final downloadedFile = File(tempFilePath);

      return await jwpubUnzip(downloadedFile, context);
    }
    else {
