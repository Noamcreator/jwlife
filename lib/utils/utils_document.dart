...
Future<String> createHtmlContent(BuildContext context, String html, String articleClasses) async {
  final theme = Theme.of(context).brightness == Brightness.dark ? 'cc-theme--dark' : 'cc-theme--light';
  final backgroundColor = Theme.of(context).brightness == Brightness.dark ? '#111111' : '#ffffff';
  final fontSize = await getFontSize();
  String cssCode = await rootBundle.loadString('assets/webapp/collector.css');
  ...
  return '''
    ...
    <div class="$articleClasses $theme">
    $html
    </div>
    </body>
    </html>
