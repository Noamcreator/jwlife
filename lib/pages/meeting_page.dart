...
import 'meeting_pages/regional_convention_menu_page.dart';
import 'meeting_pages/watchtower_page.dart';
        ...
        body: isLoading
          ...
          children: [
            ...
            Expanded(
              child: TabBarView(
                children: <Widget>[
                  if (docLaM != null && docIdLaM != null)
                    LifeAndMinistryPage(doc: docLaM!, docId: docIdLaM!)
                  else
                    const Center(child: Text("Pas de contenu pour Vie et Ministère")),
                  if (docWatchtower != null && docIdWatchtower != null)
                    WatchTowerPage(html: docWatchtower!, docId: docIdWatchtower!)
                  else
                    const Center(child: Text("Pas de contenu pour La Tour de Garde")),
                  Center(child: Text('Assemblé de circonscription')),
                  if (regional_convention_pub != null)
                    RegionalConventionMenu(publication: regional_convention_pub!)
                  else
