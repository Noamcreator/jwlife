...
class _HomePageState extends State<HomePage> {
  ...
  dynamic article = {};
  List<Map<String, dynamic>> lastPublications = [];
  ...
  Future<void> _refresh({bool first=false}) async {
    ...
    bool catalogUpdate = await Api.catalogHasUpdate();

    // Vérifier si une mise à jour de la bibliothèque est disponible
    bool libraryUpdate = await Api.libraryHasUpdate(JwLifeApp.currentLanguage.symbol);
    ...
    if (libraryUpdate || catalogUpdate) {
      // Lorsque les mises à jour sont terminées
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (doc != null) {
          ...
          throw Exception('Element with class .tabContent not found');
        }
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (article['title'] != null)
                    SizedBox(
                      height: 410, // Hauteur du conteneur
                      child: Stack(
                        children: [
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                var mediaItem = LoadPages.teachingToolboxVideos[index];
                                return Padding(
                                  padding: EdgeInsets.only(left: 2.0, right: 2.0),
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: lastPublications.length,
                              itemBuilder: (context, index) {
                                dynamic publication = lastPublications[index];
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, mediaIndex) {
                                MediaItem mediaItem = LoadPages.latestAudiosVideos[mediaIndex];
                                      ...
                                      child: Stack(
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: mediaItem.realmImages?.wideFullSizeImageUrl != null
                                                ? ImageCachedWidget(
