...
import 'package:jwlife/pages/home_pages/alert_info_page.dart';
...
class AlertBanner extends StatefulWidget {
  ...
  const AlertBanner({Key? key, required this.alerts}) : super(key: key);
        ...
        Navigator.push(
          ...
          PageRouteBuilder(
            pageBuilder: (BuildContext context, Animation<double> animation1, Animation<double> animation2) {
              return AlertInfoPage(alerts: widget.alerts);
            },
