...
import 'package:jwlife/pages/library_pages/publication_pages/publication_media_items_view.dart';
import 'package:jwlife/pages/library_pages/publication_pages/publication_notes_view.dart';
import 'package:jwlife/pages/library_pages/publication_pages/publication_svg_view.dart';
import 'package:share_plus/share_plus.dart';
import '../../../jwlife.dart';
import '../../../utils/icons.dart';
import '../../../widgets/htmlView/html_widget.dart';
import '../../../widgets/publication/verse_dialog.dart';
                ...
                PopupMenuItem<String>(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      PageRouteBuilder(
                        pageBuilder: (BuildContext context, Animation<double> animation1, Animation<double> animation2) {
                          return PublicationMediaItemsView(document: _data);
                        },
                        transitionDuration: Duration.zero,
                        reverseTransitionDuration: Duration.zero,
                      ),
              ...
              children: [
                SingleChildScrollView(
                  ...
                  child: HtmlWidget(
                    _data,
                    enableCaching: true,
                    textStyle: TextStyle(fontSize: _textSize),
                    /*
                    customStylesBuilder: (htmlElement) {
                      return getJwStyles(context, htmlElement);
                    },
                    customWidgetBuilder: (element) {
                      int docId = widget.navCards[_currentIndex]['docId']!;
                      return getJwWidget(context, element, _textInputs, _blockRange, _images,widget.publication, docId, fetchHyperlink);
                    },

                     */
                  ),
                ),
                _showVerseDialog ? VerseDialogItem(verses: _pubJson, onClose: closeVerseDialog, position: _verseDialogPosition) : Container(),
              ],
            )
          );
        },
