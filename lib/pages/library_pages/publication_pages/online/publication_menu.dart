...
import 'package:jwlife/pages/library_pages/publication_pages/page_document_test.dart';
import 'package:jwlife/pages/library_pages/publication_pages/pages_document_view.dart';
                ...
                child: InkWell(
                  onTap: () {
                    ...
                    Navigator.push(
                      ...
                      PageRouteBuilder(
                        pageBuilder: (BuildContext context, Animation<double> animation1, Animation<double> animation2) {
                          return PagesDocumentViewTest(
                            publication: _publicationData,
                            currentIndex: card['id'],
                            navCards: _allNavigationCards, // Passez la liste des navCards
                          );
                        },
                        transitionDuration: Duration.zero,
                        reverseTransitionDuration: Duration.zero,
